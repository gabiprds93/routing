			...
			<div className="container">
				<div className="course-header">
					...
					<ul className="nav navbar-nav navbar-right text-uppercase col-md-6">
						<li className={CurrentList == Html ? "active" : ""}><a href='#/courses/html'>HTML</a></li>
						<li className={CurrentList == Css ? "active" : ""}><a href='#/courses/css'>CSS</a></li>
						<li className={CurrentList == Javascript ? "active" : ""}><a href='#/courses/javascript'>JavaScript</a></li>
					</ul>
                        </div>
				<div className="">
				      <CurrentList />
                  ...
                  <nav className="navbar navbar-default">
                        <div className="container-fluid">
                              ...
                              <ul className="nav navbar-nav navbar-right text-uppercase">
                                    <li className={Child == Home ? "active" : ""}><a href="#/home">Home</a></li>
                                    <li className={Child == About ? "active" : ""}><a href="#/about">About</a></li>
                                    <li className={Child == Teachers ? "active" : ""}><a href="#/teachers">Teachers</a></li>
                                    <li className={Child == Courses ? "active" : ""}><a href="#/courses">Courses</a></li>
                              </ul>
                        </div>
                  </nav>
